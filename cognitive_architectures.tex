...
Then various actors on stage get the spotlight shone upon them (according to the pandemonium theory which is often used cited; the one who shouts the loudest, basically\cite{selfridge1958pandemonium}), and is allowed to share its message with the the audience.

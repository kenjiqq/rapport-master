...
Various types of frameworks, like the Qt application framework or Ruby on Rails web application framework, have been successfully used in software development for a long time to simplify and ease the implementation software projects.
...
{\em Nodes} and {\em Links} are the two major data structures used for representing information in the LIDA framework. They contain an {\em activation level} which describes their {\em salience} (their relative value).
...
This object factory provides a way to easily generate objects for common data structures and strategies.
